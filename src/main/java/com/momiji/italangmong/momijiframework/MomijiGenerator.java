package com.momiji.italangmong.momijiframework;
...
public class MomijiGenerator extends DefaultCodegen implements CodegenConfig {
  ...
  public String getHelp() {
    return "Generates a momiji client library.";
  }

  public MomijiGenerator() {
    super();

    // set the output folder here
    outputFolder = "generated-code/momiji";
     ...
     */
    // supportingFiles.add(new SupportingFile("IParameterizable.mustache", // the
    // input template or file
    // "", // the destination folder, relative `outputFolder`
    // "IParameterizable.cs") // the output file
    // );
   ...
   * `Property` into either language specific types via `typeMapping` or into
